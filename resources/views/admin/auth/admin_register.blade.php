    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin_user_register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="permission" type="text" class="form-control @error('permission') is-invalid @enderror" name="permission" required autocomplete="permission">
