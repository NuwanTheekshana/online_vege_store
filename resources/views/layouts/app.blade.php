...
<body class="goto-here">
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item cta cta-colored"><a href="{{route('cart')}}" class="nav-link"><span class="icon-shopping_cart"></span>[ <span id="shopping_count">{{$add_to_cart_count}}</span> ]</a></li>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="user_profile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle-o"></i> {{ Auth::user()->F_name }} {{ Auth::user()->L_name }}</a>
            ...
            <div class="col-md">
              <div class="ftco-footer-widget mb-4 ml-md-5">
                ...
                <ul class="list-unstyled">
                  <li><a href="{{route('shopping')}}" class="py-2 d-block">Shop</a></li>
                  <li><a href="{{route('about_us')}}" class="py-2 d-block">About</a></li>
                  <li><a href="{{route('contact_us')}}" class="py-2 d-block">Contact Us</a></li>
                </ul>
              </div>
            </div>
            <div class="col-md-4">
  ...
  @include('shopping.script/js_script');
  <script src="{{asset('js/jquery.min.js')}}"></script>
